                                    ...
                                    <ul class="menu-subnav">
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{route('admin.'.$name.'.index')}}" class="menu-link">
                                                ...
                                                <span class="menu-text">View Weight</span>
                                            </a>
                                        </li>
                                        @if(auth()->user()->hasPermission('read_'.$name))
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{route('admin.'.$name.'.create')}}" class="menu-link">
                                                ...
                                                <span class="menu-text">Create Weight</span>
                                            </a>
                                        </li>
                                        @endif
                                    </ul>
                                    ...
                                    <ul class="menu-subnav">
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{route('admin.'.$name.'.index')}}" class="menu-link">
                                                ...
                                                <span class="menu-text">View Ingredients</span>
                                            </a>
                                        </li>
                                        @if(auth()->user()->hasPermission('read_'.$name))
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{route('admin.'.$name.'.create')}}" class="menu-link">
                                                ...
                                                <span class="menu-text">Create Ingredient</span>
                                            </a>
                                        </li>
                                        @endif
                                    </ul>
                        ...
                        <li class="menu-item {{is_active(2, 'contacts')}}" aria-haspopup="true" >
